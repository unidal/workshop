...
import com.site.web.http.HttpServletRequestWrapper;
...
public class PayloadProviderTest extends ComponentTestCase {
	...
	public void testComplexValue2() throws Exception {
		...
		checkQueryString(payload, "int", "1", "long", "2", "boolean", "1", "double", "123.4", "string", "String Value", "int", "1",
				"long", "2", "boolean", "1", "double", "123.4", "string", "String Value");
