...
public class XmlMetaTest extends ComponentTestCase {
   ...
   @Ignore
   @Test
   public void notestEbayService() throws Exception {
      XmlMeta xmlMeta = lookup(XmlMeta.class);
      XMLOutputter outputter = new XMLOutputter(Format.getPrettyFormat());
      StringWriter writer = new StringWriter(8192);
      Element root = xmlMeta.getMeta(new InputStreamReader(getClass().getResourceAsStream("eBaySvc.xml"), "utf-8"));
   ...
   public void testGuessType() {
      ...
      assertEquals("EEE, d MMM yyyy HH:mm:ss z", DefaultXmlMeta.Utils.guessValueTypeAndFormat("Tue, 27 Jan 2009 12:40:01 GMT")[1]);
