...
public class WizardModelGeneratorTest extends ComponentTestCase {
   ...
   public void testGenerateWizardModel() throws Exception {
      ...
      URL manifestXml = getResourceFile("wizard-manifest.xml").toURI().toURL();
   ...
   class DalGenerateContext extends AbstractGenerateContext {
      ...
      public DalGenerateContext(File projectBase, String type, URL manifestXml) {
         super(projectBase, "/META-INF/dal/" + type, "target/generated-model/wizard");
