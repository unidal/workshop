...
import com.ebay.eunit.annotation.testng.ConfigurationFile;
import com.ebay.eunit.model.entity.EunitMethod;
import com.ebay.eunit.testfwk.EunitRuntimeConfig;
import com.ebay.eunit.testfwk.junit.BaseJUnit4Runner;
import com.ebay.eunit.testfwk.junit.JUnitCallback;
import com.ebay.eunit.testfwk.junit.JUnitTestPlan.Entry;
...
import com.ebay.eunit.testfwk.spi.filter.IGroupFilter;
import com.ebay.eunit.testfwk.spi.filter.RunOption;
import com.ebay.eunit.testfwk.testng.EunitTestNGConfigurator;
      ...
      if (meta != null) {
         ...
         if (in == null) {
            ...
            try {
               ...
               throw new RuntimeException(String.format("Unable to parse XML configuration file(%s)! error: %s.", xmlFile,
                     e.getMessage()), e);
            }
         }
      }
