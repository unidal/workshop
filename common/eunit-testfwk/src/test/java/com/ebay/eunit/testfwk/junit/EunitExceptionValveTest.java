...
import com.ebay.eunit.BaseJUnit4RunnerTest;
...
public class EunitExceptionValveTest extends BaseJUnit4RunnerTest {
   ...
   public void a2() throws Exception {
      checkMethod(SingleExceptionTest.class, "a2", AssertionFailedError.class);
   }
   ...
   public void m9() throws Exception {
      checkMethod(MultipleExceptionsTest.class, "m9", AssertionFailedError.class);
   }
