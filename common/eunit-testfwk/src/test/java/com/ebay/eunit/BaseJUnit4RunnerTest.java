...
public class BaseJUnit4RunnerTest {
   ...
   protected void checkException(final Class<?> expectedException, Throwable actual) throws AssertionFailedError, Error {
      if (actual == null && expectedException != null) {
         throw new AssertionFailedError(String.format("Exception exception(%s) to be thrown!", expectedException.getName()));
      } else if (actual != null) {
         if (expectedException == null) {
            ...
            throw new AssertionFailedError(String.format("Exception exception(%s) to be thrown, but was %s!",
