...
public class FindQueryTest extends ComponentTestCase {
   public void testList() throws Exception {
      ...
      WdbcSource source = new ResourceSource(WdbcSourceType.HTML, "/pages/carsinfo/list.html");
   ...
   public void testDetails() throws Exception {
      ...
      WdbcEngine engine = lookup(WdbcEngine.class);
      WdbcSource source = new ResourceSource(WdbcSourceType.HTML, "/pages/carsinfo/details.html");
      WdbcResult result = engine.execute(query, source);
