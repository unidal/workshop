...
public class QueryTest extends ComponentTestCase {
   public void testList() throws Exception {
      ...
      WdbcSource source = new ResourceSource(WdbcSourceType.HTML, "pages/wswl/list.html", "utf-8");
      WdbcResult result = engine.execute(query, source);

      assertNotNull(result);
      assertEquals(15, result.getRowSize());
   }
   ...
   public void testDetails() throws Exception {
      ...
      WdbcEngine engine = lookup(WdbcEngine.class);
      WdbcSource source = new ResourceSource(WdbcSourceType.HTML, "pages/wswl/details.html", "utf-8");
      WdbcResult result = engine.execute(query, source);
