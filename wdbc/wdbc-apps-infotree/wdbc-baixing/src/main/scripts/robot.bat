...
REM    -Dcategory            Category id to be fetched from. Default value is "baomu".
REM    -Dcategory.infotree   Which category id of InfoTree.com to store data to. Default value is "349".
REM    -Dcity                City code in the URL. Default value is "shanghai".
...
java -Dcategory=baomu -Dcategory.infotree=349 -Dcity=shanghai -jar wdbc-baixing.jar
