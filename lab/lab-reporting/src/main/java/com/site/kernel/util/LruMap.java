 ...
 *
 * <p>
 * This version of LRUMap does use a true LRU algorithm.
 * The keys for all gets and puts are moved to the front of the list.
 * LRUMap is a subclass of SequencedHashMap, and the "LRU"
