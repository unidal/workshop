...
/**
 *  This class is modified from apache open source -
...
public class SequencedHashMap implements Map, Cloneable, Externalizable {
   ...
   **/
  private HashMap<Object, Entry> entries;
  ...
  public SequencedHashMap() {
    ...
    entries = new HashMap<Object, Entry>();
  }
  ...
  public SequencedHashMap(int initialSize) {
    sentinel = createSentinel();
    entries = new HashMap<Object, Entry>(initialSize);
  }
  ...
  public SequencedHashMap(int initialSize, float loadFactor) {
    sentinel = createSentinel();
    entries = new HashMap<Object, Entry>(initialSize, loadFactor);
  }
...
public Set entrySet() {
  ...
  class OrderedIterator implements Iterator {
     ...
     *  #VALUE}, or {@link #ENTRY}.
     **/
    private OrderedIterator(int returnType) {
    ...
    /**
     *  reset the iterator for reuse internally within the package
     **/
    void reset() {
       pos = sentinel;
  ...
  public Object clone () throws CloneNotSupportedException {
    ...
    map.entries = new HashMap<Object, Entry>();
