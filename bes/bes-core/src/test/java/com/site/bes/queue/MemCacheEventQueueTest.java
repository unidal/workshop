...
public class MemCacheEventQueueTest extends ComponentTestCase {
   public void testAdd() throws Exception {
      EventQueue queue = lookup(EventQueue.class, "memcache");
   ...
   public void testPoll() throws Exception {
      ...
      assertTrue(last.getScheduleDate().getTime() > System.currentTimeMillis() - 1000L + 24 * 60 * 60 * 1000L);
      assertNotNull(last.getCreationDate());
      assertTrue(last.getCreationDate().getTime() > System.currentTimeMillis() - 1000L);
   }
