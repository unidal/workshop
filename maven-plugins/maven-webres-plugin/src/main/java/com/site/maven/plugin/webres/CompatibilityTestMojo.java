...
import com.site.maven.plugin.webres.model.entity.ConstructorModel;
import com.site.maven.plugin.webres.model.entity.Failure;
import com.site.maven.plugin.webres.model.entity.FieldModel;
import com.site.maven.plugin.webres.model.entity.MethodModel;
import com.site.maven.plugin.webres.model.entity.Report;
import com.site.maven.plugin.webres.model.entity.TypeModel;
...
public class CompatibilityTestMojo extends AbstractMojoWithDependency {
   ...
   protected void initialize() {
      ...
      m_errorHandler = new IRuleErrorHandler() {
         @Override
      ...
      m_exemptionHandler = new IRuleExemptionHandler() {
         @Override
