...
import static com.site.maven.plugin.webres.rule.RuleExemption.INVISIBLE_MEMBER_CLASS_SKIPPED;
import static com.site.maven.plugin.webres.rule.RuleFailure.CLASS_EXTENSIBILITY_DEGRADED;
import static com.site.maven.plugin.webres.rule.RuleFailure.CLASS_REMOVED;
import static com.site.maven.plugin.webres.rule.RuleFailure.CLASS_TYPE_CHANGED;
import static com.site.maven.plugin.webres.rule.RuleFailure.CLASS_VISIBILITY_DEGRADED;
import static com.site.maven.plugin.webres.rule.RuleFailure.FIELD_MEMBERSHIP_CHANGED;
import static com.site.maven.plugin.webres.rule.RuleFailure.FIELD_REMOVED;
import static com.site.maven.plugin.webres.rule.RuleFailure.FIELD_VISIBILITY_DEGRADED;
import static com.site.maven.plugin.webres.rule.RuleFailure.METHOD_MEMBERSHIP_CHANGED;
import static com.site.maven.plugin.webres.rule.RuleFailure.METHOD_REMOVED;
import static com.site.maven.plugin.webres.rule.RuleFailure.METHOD_VISIBILITY_DEGRADED;
...
import com.site.maven.plugin.webres.rule.IRuleErrorHandler;
import com.site.maven.plugin.webres.rule.IRuleExemptionHandler;
import com.site.maven.plugin.webres.rule.RuleConfigurator;
import com.site.maven.plugin.webres.rule.RuleEngine;
import com.site.maven.plugin.webres.rule.RuleExemption;
import com.site.maven.plugin.webres.rule.RuleFailure;
