...
public class MojoTest extends ComponentTestCase {
	public void testGenerateDalJdbc() throws Exception {
		...
		assertTrue("Compile sources is not added", project
				.getCompileSourceRoots().contains(mojo.sourceDir));
	...
	public void testGenerateDalJdbcMeta() throws Exception {
		...
		try {
			...
			if (cause instanceof SQLException) {
				...
				if (sqle.getCause() instanceof ConnectException
	...
	public void testGenerateDalXml() throws Exception {
		...
		if (!debug) {
			...
			mojo.manifest = debugBaseDir
					+ "/src/main/resources/META-INF/dal/xml/manifest.xml";
		}
