...
import static com.site.test.user.dal.UserEntity.*;
import static com.site.test.user.dal.UserEntity.CREATION_DATE;
import static com.site.test.user.dal.UserEntity.HOME_ADDRESS;
import static com.site.test.user.dal.UserEntity.KEY_USER_ID;
import static com.site.test.user.dal.UserEntity.LAST_MODIFIED_DATE;
import static com.site.test.user.dal.UserEntity.OFFICE_ADDRESS;
import static com.site.test.user.dal.UserEntity.UPPER_USER_NAME;
import static com.site.test.user.dal.UserEntity.USER_ID;
import static com.site.test.user.dal.UserEntity.USER_ID_ARRAY;
import static com.site.test.user.dal.UserEntity.USER_ID_LIST;
import static com.site.test.user.dal.UserEntity.USER_NAME;
