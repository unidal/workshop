 ...
 * @author Jeff Dinkins
 */
public class EducationApp extends JPanel {
   ...
   // List of demos
   private ArrayList<BaseModule> demosList = new ArrayList<BaseModule>();
   ...
   private BaseModule currentDemo = null;
   ...
   private EducationApplet applet = null;
   ...
   private static Vector<EducationApp> swingSets = new Vector<EducationApp>();

   private boolean dragEnabled = false;

   public EducationApp(EducationApplet applet) {
      this(applet, null);
   }
    ...
    */
   public EducationApp(EducationApplet applet, GraphicsConfiguration gc) {
   ...
   public static void main(String[] args) {
      ...
      EducationApp swingset = new EducationApp(null, GraphicsEnvironment.getLocalGraphicsEnvironment()
   ...
   BaseModule currentTabDemo = null;
   ...
   public JMenuBar createMenus() {
      ...
      createMenuItem(fileMenu, "FileMenu.open_label", "FileMenu.open_mnemonic", "FileMenu.open_accessible_description",
            null);

      createMenuItem(fileMenu, "FileMenu.save_label", "FileMenu.save_mnemonic", "FileMenu.save_accessible_description",
            null);
   ...
   public void preloadFirstDemo() {
      BaseModule demo = addDemo(new InternalFrameDemo(this));
      setDemo(demo);
   }
    ...
    */
   public BaseModule addDemo(BaseModule demo) {
      demosList.add(demo);
      if (dragEnabled) {
      ...
      SwingUtilities.invokeLater(new SwingSetRunnable(this, demo) {
         public void run() {
            SwitchToDemoAction action = new SwitchToDemoAction(swingset, (BaseModule) obj);
            ...
            tb.setText(null);
            tb.setToolTipText(((BaseModule) obj).getToolTip());
    ...
    */
   public void setDemo(BaseModule demo) {
      currentDemo = demo;

      // Ensure panel's UI is current before making visible
      JComponent currentDemoPanel = demo.getPanel();
   ...
   public void showSwingSet2() {
      if (!isApplet() && getFrame() != null) {
         ...
         int centerWidth = screenRect.width < f.getSize().width ? screenRect.x : screenRect.x + screenRect.width / 2
               - f.getSize().width / 2;
         int centerHeight = screenRect.height < f.getSize().height ? screenRect.y : screenRect.y + screenRect.height
   ...
   void loadDemo(String classname) {
      ...
      BaseModule demo = null;
      try {
         Class demoClass = Class.forName(classname);
         Constructor demoConstructor = demoClass.getConstructor(new Class[] { EducationApp.class });
         demo = (BaseModule) demoConstructor.newInstance(new Object[] { this });
         addDemo(demo);
      } catch (Exception e) {
    ...
    */
   public EducationApplet getApplet() {
      return applet;
   }
   ...
   public void setLookAndFeel(String laf) {
      if (currentLookAndFeel != laf) {
         ...
         /*
          * The recommended way of synchronizing state between multiple controls
          * that represent the same command is to use Actions. The code below is
          * a workaround and will be replaced in future version of SwingSet2
          * demo.
          */
         String lafName = null;
         if (laf == mac)
    ...
    * tab
    */
   public void setSourceCode(BaseModule demo) {
      // do the following on the gui thread
      SwingUtilities.invokeLater(new SwingSetRunnable(this, demo) {
         public void run() {
            swingset.demoSrcPane.setText(((BaseModule) obj).getSourceCode());
   ...
   class SwingSetRunnable implements Runnable {
      protected EducationApp swingset;
      protected Object obj;

      public SwingSetRunnable(EducationApp swingset, Object obj) {
   ...
   public class SwitchToDemoAction extends AbstractAction {
      EducationApp swingset;
      BaseModule demo;

      public SwitchToDemoAction(EducationApp swingset, BaseModule demo) {
   ...
   class ChangeLookAndFeelAction extends AbstractAction {
      ...
      protected ChangeLookAndFeelAction(EducationApp swingset, String laf) {
         super("ChangeTheme");
         this.swingset = swingset;
         this.laf = laf;
      }
   ...
   class ActivatePopupMenuAction extends AbstractAction {
      ...
      protected ActivatePopupMenuAction(EducationApp swingset, JPopupMenu popup) {
   ...
   class OnAudioAction extends AbstractAction {
      ...
      protected OnAudioAction(EducationApp swingset) {
         super("Audio On");
         this.swingset = swingset;
      }
   ...
   class DefaultAudioAction extends AbstractAction {
      ...
      protected DefaultAudioAction(EducationApp swingset) {
         super("Audio Default");
         this.swingset = swingset;
      }
   ...
   class OffAudioAction extends AbstractAction {
      ...
      protected OffAudioAction(EducationApp swingset) {
         super("Audio Off");
         this.swingset = swingset;
      }
   ...
   class ChangeThemeAction extends AbstractAction {
      ...
      protected ChangeThemeAction(EducationApp swingset, MetalTheme theme) {
         super("ChangeTheme");
         this.swingset = swingset;
         this.theme = theme;
      }
   ...
   class ExitAction extends AbstractAction {
      ...
      protected ExitAction(EducationApp swingset) {
         super("ExitAction");
         this.swingset = swingset;
      }
   ...
   class AboutAction extends AbstractAction {
      ...
      protected AboutAction(EducationApp swingset) {
         super("AboutAction");
         this.swingset = swingset;
      }
   ...
   class MultiScreenAction extends AbstractAction {
      ...
      protected MultiScreenAction(EducationApp swingset, int screen) {
      ...
      public void actionPerformed(ActionEvent e) {
         ...
         if (screen == ALL_SCREENS) {
            for (int i = 0; i < gds.length; i++) {
               EducationApp swingset = new EducationApp(null, gds[i].getDefaultConfiguration());
               swingset.setDragEnabled(dragEnabled);
            }
         } else {
            EducationApp swingset = new EducationApp(null, gds[screen].getDefaultConfiguration());
            swingset.setDragEnabled(dragEnabled);
         }
      }
   }
   ...
   class DemoLoadThread extends Thread {
      ...
      public DemoLoadThread(EducationApp swingset) {
         this.swingset = swingset;
      }
   ...
   class AboutPanel extends JPanel {
      ...
      EducationApp swingset = null;

      public AboutPanel(EducationApp swingset) {
         this.swingset = swingset;
   ...
   private class ChangeFontAction extends AbstractAction {
      private EducationApp swingset;
      private boolean plain;

      ChangeFontAction(EducationApp swingset, boolean plain) {
         super("FontMenu");
         this.swingset = swingset;
         this.plain = plain;
      }
